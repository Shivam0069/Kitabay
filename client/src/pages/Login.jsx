...
const Login = () => {
  ...
  return (
    <>
      <div className="flex flex-col justify-center md:flex-row-reverse h-screen">
          ...
          <div className="w-full max-w-sm">
            <div className="flex justify-center mb-12">
              <div className="flex flex-col-reverse items-center justify-center gap-5">
                <h3 className="font-medium overflow-hidden text-4xl">
                  Welcome Back
                </h3>
                <img
                  src={logo}
            ...
            <form onSubmit={(e) => handleLogin(e)}>
              ...
              <div className=" md:hidden  font-semibold mt-5 flex items-center gap-2">
